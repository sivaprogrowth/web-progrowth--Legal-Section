...
const servicesData = ["Fractional CMO", "AI Assisted Services"];
      ...
      <div className="flex flex-col items-center justify-center gap-[100px] relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
          <div className="inline-flex flex-col items-start gap-10 relative flex-[0_0_auto]">
            ...
            <button
              className="all-[unset] box-border inline-flex items-center gap-[30px] pl-[26px] pr-3 pt-[9px] pb-[11px] relative flex-[0_0_auto] bg-[#ffffff1a] rounded-[50px] overflow-hidden cursor-pointer hover:bg-[#ffffff26] transition-colors"
            ...
            >
              <div className="inline-flex flex-col items-center justify-center relative flex-[0_0_auto] z-[1]">
                <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                  <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-fit mt-[-1.00px] [font-family:'Manrope',Helvetica] font-medium text-white text-base tracking-[0] leading-[20.8px] whitespace-nowrap">
                      Contact us
                    </div>
                  </div>
                </div>
              ...
              <img
                ...
                alt="Arrow"
                src="https://c.animaapp.com/TRpfoBaJ/img/arrow-2.svg"
              />
            </button>
          </div>
            ...
            <ul className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto]">
              {quickLinksData.map((link, index) => (
                <li key={index} className="self-stretch">
                  <a
                    href="#"
                    className="block mt-[-1.00px] font-normal text-lg [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal] hover:text-gray-300 transition-colors"
                  >
                    {link}
                  </a>
                </li>
            ...
            <ul className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
              {servicesData.map((service, index) => (
                <li key={index}>
                  <a
                    href="#"
                    className="w-fit mt-[-1.00px] font-normal text-lg [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal] hover:text-gray-300 transition-colors"
                  >
                    {service}
                  </a>
                </li>
          ...
          <div className="flex flex-col w-[300px] items-start gap-6 relative">
            <h3 className="w-fit mt-[-1.00px] font-medium text-2xl [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal]">
              Our Presence
            </h3>
            ...
            <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                ...
                >
                  ...
                  <div className="flex items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                    <img
                      ...
                      alt="Location"
                      src="https://c.animaapp.com/TRpfoBaJ/img/distance-5@2x.png"
                    />
              ...
              >
                <img
                  ...
                  alt="LinkedIn"
                  src="https://c.animaapp.com/TRpfoBaJ/img/linkedin-icon-2.svg"
                />
              </a>
            </div>
          </div>
