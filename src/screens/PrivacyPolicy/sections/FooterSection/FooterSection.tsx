...
export const FooterSection = (): JSX.Element => {
  ...
  const services = [
    ...
    { label: "AI Assisted Services", href: "/services/ai-assisted" },
  ];
      ...
      <div className="flex flex-col items-center justify-center gap-[100px] relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
          <div className="inline-flex flex-col items-start gap-10 relative flex-[0_0_auto]">
            ...
            >
              ...
              <img
                ...
                alt="Arrow"
                src="https://c.animaapp.com/TRpfoBaJ/img/arrow-1.svg"
              />
            </button>
          </div>
          ...
          >
            ...
            <ul className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto] list-none p-0 m-0">
              {quickLinks.map((link, index) => (
                <li key={index} className="self-stretch">
                  <a
                    href={link.href}
                    className={`${index === 0 ? "mt-[-1.00px]" : ""} ${index === 2 ? "w-fit mr-[-4.00px]" : "self-stretch"} font-normal text-lg relative [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal] hover:text-gray-300 transition-colors no-underline block`}
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto] list-none p-0 m-0">
              {services.map((service, index) => (
                <li key={index}>
                  <a
                    href={service.href}
                    className={`w-fit ${index === 0 ? "mt-[-1.00px]" : ""} font-normal text-lg relative [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal] hover:text-gray-300 transition-colors no-underline block`}
                  >
                    {service.label}
                  </a>
                </li>
                ...
                >
                  ...
                  <div className="flex items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                    <img
                      ...
                      alt="Location"
                      src="https://c.animaapp.com/TRpfoBaJ/img/distance-3@2x.png"
                    />
