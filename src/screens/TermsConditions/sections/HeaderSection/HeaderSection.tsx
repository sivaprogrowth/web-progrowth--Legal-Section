    ...
    <header className="flex w-[1440px] h-[78px] items-center justify-between px-[120px] py-6 relative bg-white border-b [border-bottom-style:solid] border">
      ...
      >
        {navigationItems.map((item, index) => (
          ...
          >
            <div
              className={`relative w-fit ${index !== 2 ? "mt-[-1.00px]" : ""} [font-family:'Manrope',Helvetica] font-normal text-[#444a46] text-base text-center tracking-[0] leading-[22px] whitespace-nowrap`}
            >
              {item.label}
            </div>
            {item.hasDropdown && (
      ...
      <button className="all-[unset] box-border inline-flex items-center gap-[30px] px-6 py-2.5 relative flex-[0_0_auto] mt-[-5.50px] mb-[-5.50px] bg-[#c5f34b] rounded-[50px] overflow-hidden hover:bg-[#b8e642] focus:outline-none focus:ring-2 focus:ring-[#c5f34b] focus:ring-offset-2 transition-colors duration-200">
